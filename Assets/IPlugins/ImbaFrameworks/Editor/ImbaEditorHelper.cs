...
public class ImbaEditorHelper : Editor
{
    ...
    [MenuItem("Cheating/Add + 10.000 gem")]
    private static void Add1000Strone()
    {
        int currentStone = DataGameSave.GetGem();
        currentStone += 10000;
        DataGameSave.SetGem(currentStone);
    }

    [MenuItem("Cheating/Add + 1 level")]
    private static void AddLevel()
    {
        int level = DataGameSave.GetLevel();
        DataGameSave.SetLevel(level + 1);
    }    
}
