...
namespace Imba.Editor.UI
{
    ...
    public class UITransformInspector : UnityEditor.Editor
    {
        static public UITransformInspector instance;
        ...
        {
            UIEditorTools.SetLabelWidth(15f);
        ...
        void DrawRotation(bool isWidget)
        {
            GUILayout.BeginHorizontal();
            {
                ...
                {
                    UIEditorTools.RegisterUndo("Change Rotation", serializedObject.targetObjects);
